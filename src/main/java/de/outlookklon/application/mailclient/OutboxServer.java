...
import de.outlookklon.application.mailclient.javamail.ServiceWrapper;
...
public abstract class OutboxServer extends MailServer {
    ...
    /**
     * Gibt das Transport-Objekt des Servers zurück.
     *
     * @param user Benutzername
     * @param passwd Password
     * @return Transport-Objekt
     * @throws NoSuchProviderException Tritt auf, wenn das Protokoll der
     * implementierenden Klasse nicht unterstützt wird.
     */
