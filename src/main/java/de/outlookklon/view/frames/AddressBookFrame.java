...
import de.outlookklon.view.dialogs.ContactFrame;
import de.outlookklon.view.dialogs.ExtendedDialog;
...
public class AddressBookFrame extends ExtendedFrame {
     ...
     */
    private static final class ListDialog extends ExtendedDialog<String> {
