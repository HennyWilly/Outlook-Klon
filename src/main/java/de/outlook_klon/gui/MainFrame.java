...
public class MainFrame extends ExtendedFrame {
	...
	private static DateFormat dateFormater = DateFormat.getDateTimeInstance(DateFormat.FULL, DateFormat.MEDIUM,
			Locale.getDefault());
	 ...
	 * 
	 * @param neu
	 *            Wenn true, wird vor dem Öffnen ein neues KontaktFrame
